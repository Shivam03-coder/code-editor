...
import CodeRuning from "./code.run";
import { useAppSelector } from "@/store";

function OutputPanel() {
  const { output, error, isRunning } = useAppSelector((state) => state.editor);
  ...
  return (
    <div className="relative flex-1 rounded-xl bg-header p-4 ring-1 ring-gray-800/50">
      {/* Header */}
